...
;(function($){
	$.fn.superfish = function(op){
		...
		var sf = $.fn.superfish,
			c = sf.c,
			$arrow = $('<span class="'+c.arrowClass+'" style="float:right;"></span>'),
			over = function(){
        ...
        if ($ul.length > 0 && !$ul.is(':visible')){
          ...
          if (e.type === 'MSPointerDown'){
			...
			addArrows = function($li,o){
				if (o.autoArrows && $li.hasClass('sub-menu-item')){
	...
	$.fn.extend({
		...
		showSuperfishUl : function(){
			...
			o.onBeforeShow.call($ul);
                        //$ul.stop().show("drop", { direction: "up", distance:15}, o.speed, function(){ o.onShow.call($ul); });
