...
HTML;
		...
		if(!empty($sidebars)){
			echo '<div class="sidebar-title">'.__('Below are the Sidebars you have created','inpress_admin').'</div>';
			foreach($sidebars as $sidebar){
				echo '<div class="sidebar-item"><span>'.$sidebar.'</span><input type="hidden" class="sidebar-item-value" value="'.$sidebar.'"/><input type="button" class="button" value="'.__('Delete','inpress_admin').'"/></div>';
			}
		}
...
$options = array(
	...
	array(
            ...
            array(
                "name" => __("Generate Sidebar",'inpress_admin'),
                "desc" => __("Enter the name of sidebar you'd like to create.",'inpress_admin'),
                "id" => THEME_SHORTNAME."-sidebars",
